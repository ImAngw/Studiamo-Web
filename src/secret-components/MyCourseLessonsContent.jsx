...
import MyCourseLessons from "./MyCourseLessons";
import NewAddCourseLessonPage from "./NewAddCourseLessonPage";
...
export default function MyCourseLessonsContent({courseList}) {
    ...
    const {setAllLessons} = useCourseLessonsData()
            ...
            */}
            ...
            {showAlert &&
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <SuccessAlert show={showAlert} onClose={() => setShowAlert(false)} text={strings.add_success}/>
                </div>
            }
            ...
            {showDelAlert &&
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    {/* Sfondo semi-trasparente */}
                    <div className="absolute inset-0 bg-black/30"></div>
                    <SuccessAlert show={showDelAlert} onClose={() => setShowDelAlert(false)} text={strings.delete_success}/>
                </div>
            }

            {isOpen && (
                <NewAddCourseLessonPage
                    setIsOpen={setIsOpen}
                    setAllLessons={setAllLessons}
                    courseList={courseList}
