...
function MyLessons({studentsList, lessonTypes, lessonFormats, setShowAlert}) {
                ...
                >
                    ...
                    >
                        ...
                        <tr>
                            ...
                            <th  style={{fontSize: '16px', width:'85px', position: 'sticky', top: 0, background: '#E9E1CD', zIndex: 1}}>{strings.mod}</th>
                            <th  style={{fontSize: '16px', width:'80px', position: 'sticky', top: 0, background: '#E9E1CD', zIndex: 1}}>{strings.type}</th>
